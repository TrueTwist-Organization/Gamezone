!(function (e, t) {
    ...
    (() => {
        ...
        var e = {
                ...
                648: (e, t) => {
                    var n;
                    Object.defineProperty(t, "__esModule", { value: !0 }), (t.GOrientation = void 0), ((n = t.GOrientation || (t.GOrientation = {})).portrait = "portrait"), (n.landscape = "landscape");
                },
                441: (e, t) => {
                    Object.defineProperty(t, "__esModule", { value: !0 }),
                        (t.Singleton = void 0),
                    ...
                    class l extends i.Singleton {
                        constructor() {
                            super(...arguments),
                                ...
                                (this.idx = 0),
                                (this.percent = 0),
                                (this.tips = ["Loading images… (1/6)", "Loading models… (2/6)", "Loading sounds… (3/6)", "Loading scenes… (4/6)", "Loading player… (5/6)", "Loading misc… (6/6)"]),
                        ...
                        async init(e) {
                            if (!this.inited) {
                                a.default.init(),
                                    (this.inited = !0),
                                    g.util.isObject(e)
                                        ? ((this.options.channel = e.channel.toLowerCase()), (this.options.appName = e.appName))
                                        : ((this.options.channel = e.toLowerCase()), (this.options.appName = document.title.replace(/[ :]/g, "-"))),
                                    ...
                                    "yad" == this.options.channel
                                        ? (this.progressImg.src = "https://h5gamessdk.yyggames.com/sdk/s/_0005_yad.png")
                                        : "cargames" == this.options.channel
                                        ? (this.progressImg.src = "https://h5gamessdk.yyggames.com/sdk/s/_0000_car.png")
                                        : "bestgames" == this.options.channel
                                        ? (this.progressImg.src = "https://h5gamessdk.yyggames.com/sdk/s/_0001_bestgames.com.png")
                                        : "freegames" == this.options.channel
                                        ? ((this.isFreeGames = !0), (this.progressImg.src = "https://h5gamessdk.yyggames.com/sdk/s/_0006_freegame.png"))
                                        : "babygames" == this.options.channel
                                        ? (this.progressImg.src = "https://h5gamessdk.yyggames.com/sdk/s/_0004_baby.png")
                                        : "yiv" == this.options.channel
                                        ? (this.progressImg.src = "https://h5gamessdk.yyggames.com/sdk/s/_0003_YIV.png")
                                        : "puzzlegame" == this.options.channel
                                        ? (this.progressImg.src = "https://h5gamessdk.yyggames.com/sdk/s/puzzle-logo.png")
                                        : (this.progressImg.src = "./@base/yad.png"),
                                ...
                                try {
                                    ...
                                    (e.indexOf("gamedistribution.com") > -1 ||
                                        e.indexOf("enjoy4fun.com") > -1 ||
                                        e.indexOf("gamemonetize.") > -1 ||
                                        e.indexOf("yof.com") > -1 ||
                                        e.indexOf("miapp.yyggames.com") > -1 ||
                                        e.indexOf("yyg.myfunmax.com") > -1 ||
                                        e.indexOf("yygh5game.com") > -1 ||
                                        e.indexOf("youyigu.aazzgames.com") > -1 ||
                                        e.indexOf("agged.app") > -1 ||
                                        e.indexOf("agged.com") > -1 ||
                                        e.indexOf("crazygames.com") > -1 ||
                                        e.indexOf("gamepix.") > -1 ||
                                        e.indexOf("y8.") > -1) &&
                                        ((this.progressImg.style.display = "none"), (this.progressImg.onclick = null)),
                                        ("h5games4u" != this.options.channel && "freegames0" != this.options.channel) || ((this.progressImg.style.display = "none"), (this.progressImg.onclick = null)),
                                        e.indexOf("enjoy4fun.com") > -1 && (this.isEnjoy4fun = !0),
                                        (e.indexOf("mafa.com") > -1 || "mafa" == this.options.channel) && ((this.isMafa = !0), (this.progressImg.src = "https://h5gamessdk.yyggames.com/sdk/Mafa/400.png"));
                                } catch (e) {}
                                return addEventListener("resize", this.updateSpace.bind(this)), addEventListener("load", this.updateSpace.bind(this)), this.updateSpace(), !0;
                            }
                        }
                        adjustProgressimg() {
                            let e = document.getElementsByClassName("progress-img")[0];
                            this.isMafa || this.isFreeGames ? (e.style.maxWidth = "400px") : (e.style.maxWidth = (null == e ? void 0 : e.naturalWidth) + "px");
                        }
                        updateSpace() {
                            let e = document.getElementsByClassName("img-container")[0],
                                t = document.getElementsByClassName("progress-container")[0],
                                n = window.innerHeight;
                            0.85 * n - (null == e ? void 0 : e.clientHeight) - (null == t ? void 0 : t.clientHeight) > 5 ? (e.style.marginTop = "10vh") : (e.style.marginTop = "3vh");
                            let s = document.getElementsByClassName("progress-img")[0];
                            window.innerWidth > 300 && window.innerHeight > 450 ? this.adjustProgressimg() : (s.style.maxWidth = "80%"),
                                n - (null == e ? void 0 : e.clientHeight) - (null == t ? void 0 : t.clientHeight) < 50 || (0 == (null == e ? void 0 : e.clientHeight) && n < 350)
                                    ? ((e.style.display = "none"), (t.style.bottom = "auto"), (t.style.top = "50%"), (t.style.transform = "translateY(-50%)"))
                                    : ((e.style.display = "flex"), (t.style.bottom = "5vh"), (t.style.top = "auto"), (t.style.transform = "none")),
                                (document.getElementsByClassName("loading-container")[0].style.height = n + "px");
                        }
                        onUpdate() {
                            if (this.isEnjoy4fun)
                                return (
                                    this.percent >= 100 && ((this.percent = 100), (this.progressBar.value = this.percent)),
                                    (this.percent += 0.5),
                        ...
                        navigate() {
                            // Disabled: no ad redirect
                        }
                        setBackgroundColor(e) {
                            this.splashRoot.style.background = e;
                        }
                        setProgressBackgroundColor(e) {
                            (this.progressBackgroundColor = e), (this.progressBar.style.backgroundColor = e), this.updateStyleElement();
                        }
                        ...
                        setProgressBorderColor(e) {
                            (this.progresBorderColor = e), this.updateStyleElement();
                        }
                        setGameLogoScale(e) {}
                        setBannerScale(e) {}
                    ...
                    class n {
                        static init() {
                            try {
                                ...
                                e.indexOf("Mobile"), e.indexOf("Android") > -1 || e.indexOf("Adr"), e.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/);
                            } catch (e) {}
                        }
                        static get isMobile() {
